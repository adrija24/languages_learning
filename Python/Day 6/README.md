...
---
# Day :six:
   * To input n lines and print them at a time using file
   * To input n lines and print using file
   * To input numbers in a file and find number of even and odd using file
